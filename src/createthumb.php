...
if (is_file($thumbnail)) {
    ...
    if (preg_match("/.jpg$/i", $_GET['filename'])) ImageJPEG($target,$thumbnail,90);
    if (preg_match("/.gif$/i", $_GET['filename'])) ImageGIF($target,$thumbnail,90);
    if (preg_match("/.png$/i", $_GET['filename'])) ImageJPEG($target,$thumbnail,90); // Using ImageJPEG on purpose
